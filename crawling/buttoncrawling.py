...
class SuperChat():
    ...
    def supercraw(self):
        ...
        try:
            ...
            df.to_csv(f'C:/Github/Youtube/crawling/csv_savedata/{naljja}supercraw.csv', index = False)
    ...
    def supercraw_week(self):
        ...
        try:
            ...
            df.to_csv(f'C:/Github/Youtube/crawling/csv_savedata/{naljja}supercraw_week.csv', index = False)
            # print("---------crawling file save 완료------------")
            data = "크롤링완료"
    ...
    def LiveRank(self):
        ...
        try:
            ...
            df.to_csv(f'C:/Github/Youtube/crawling/csv_savedata/{naljja}LiveRank.csv', index = False)
            # print("---------crawling file save 완료------------")
            data = "크롤링완료"
    ...
    def LiveRank_week(self):
        ...
        try:
            ...
            df.to_csv(f'C:/Github/Youtube/crawling/csv_savedata/{naljja}LiveRank_week.csv', index = False)
            # print("---------crawling file save 완료------------")
            data = "크롤링완료"
    ...
    def mostviewvideo_week(self):
        ...
        try:
            ...
            df.to_csv(f'C:/Github/Youtube/crawling/csv_savedata/{naljja}mostviewvideo_week.csv', index = False)
            # print("---------crawling file save 완료------------")           
            data = "크롤링완료"
    ...
    def subsoaring(self):
        ...
        try:
            ...
            df.to_csv(f'C:/Github/Youtube/crawling/csv_savedata/{naljja}subsoaring.csv', index = False)
            # print("---------crawling file save 완료------------")
            data = "크롤링완료"
    ...
    def subsoaring_week(self):
        ...
        try:
            ...
            df.to_csv(f'C:/Github/Youtube/crawling/csv_savedata/{naljja}subsoaring_week.csv', index = False)
            # print("---------crawling file save 완료------------")
            data = "크롤링완료"
    ...
    def mostview(self):
        ...
        try:
            ...
            df.to_csv(f'C:/Github/Youtube/crawling/csv_savedata/{naljja}mostview.csv', index = False)
            # print("---------crawling file save 완료------------")
            data = "크롤링완료"
    ...
    def mostview_week(self):
        ...
        try:
            ...
            df.to_csv(f'C:/Github/Youtube/crawling/csv_savedata/{naljja}mostview_week.csv', index = False)
            # print("---------crawling file save 완료------------")
            data = "크롤링완료"
    ...
    def mostviewad(self):
        ...
        try:
            ...
            df.to_csv(f'C:/Github/Youtube/crawling/csv_savedata/{naljja}mostviewad.csv', index = False)
            # print("---------crawling file save 완료------------")
            data = "크롤링완료"
    ...
    def mostviewad_week(self):
        ...
        try:
            ...
            df.to_csv(f'C:/Github/Youtube/crawling/csv_savedata/{naljja}mostviewad_week.csv', index = False)
            # print("---------crawling file save 완료------------")
            data = "크롤링완료"
